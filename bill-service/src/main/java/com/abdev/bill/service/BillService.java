package com.abdev.bill.service;

import com.abdev.bill.entity.Bill;
import com.abdev.bill.exception.BillNotFountException;
import com.abdev.bill.repository.BillRepository;
...
public class BillService {
    ...
    public Bill getBillById(Long billId) {
        return billRepository.findById(billId).orElseThrow(() -> new BillNotFountException("Unable to find bill with id: " + billId));
    }
